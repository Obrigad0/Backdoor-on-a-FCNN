...
NOMEDATASET = "" #Change this to choose the backdoored dataset

# !!! To choose whether to train a model from scratch or an already trained model, follow the instructions below !! 
# ----------------------
...
train_data = torch.load(NOMEDATASET)
...
model = torch.load('MNIST_Model_CLEAN.pth')  #Comment this to train a model from scratch 
...
torch.save(model, 'MNIST_Model_BACKDOORED.pth')
# torch.save(model.state_dict(), 'MNIST_Model_WEIGHT_BACKDOORED.pth')
